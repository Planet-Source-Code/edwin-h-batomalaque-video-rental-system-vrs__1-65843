VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} receipts 
   Bindings        =   "penalty_receipts.dsx":0000
   Caption         =   "Official Receipts"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11775
   Icon            =   "penalty_receipts.dsx":001B
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   4350
         Object.Height          =   1155
         Picture         =   "penalty_receipts.dsx":128D
         SizeMode        =   1
      EndProperty
      ItemType2       =   3
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16777215
         Object.Caption         =   "Official Receipts"
      EndProperty
      ItemType3       =   3
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Sitio Toning Part II Lagao, General Santos City"
         Alignment       =   2
      EndProperty
      ItemType4       =   5
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Its all for you One Touch World Cinema"
      EndProperty
      ItemType2       =   3
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         _Version        =   393216
...
receipts.Refresh
mdifrmmain.lblstatus.Caption = "Printing Receipts"
End Sub


Private Sub DataReport_Initialize()
 With receipts.Sections("Section2").Controls
 .item("lblcustname").Caption = frmmembercash.lblborrower.Caption
 .item("lblidno").Caption = frmmembercash.lblidno.Caption
 .item("lbltot_amount").Caption = frmmembercash.lblamount.Text
 .item("lblinvoice").Caption = frmmembercash.lbltrans.Caption
 .item("lblCashAmount").Caption = frmmembercash.txtcash.Text
 .item("lblChangeAmount").Caption = frmmembercash.lblchange.Caption
 .item("lblcashier").Caption = mdifrmmain.StatusBar1.Panels(2).Text
 .item("lbltot_items").Caption = frmmembercash.lblitemscount.Caption
 End With
...
Unload Me
receipts.Refresh
myconnection.rstempview.Fields.Refresh
myconnection.rstempview.Close
