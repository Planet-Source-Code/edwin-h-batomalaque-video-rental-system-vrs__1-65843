VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} sales_report 
   Bindings        =   "daily_sales.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Consolidated Sales Report"
         Alignment       =   2
      EndProperty
      ItemType3       =   3
   ...
   EndProperty
End
Attribute VB_Name = "sales_report"
...
Me.Refresh
mdifrmmain.lblstatus.Caption = "Consolidated Sales Report"
End Sub
...
Me.Refresh
'tot.Caption = myconnection.rsGTotal.GetString
...
myconnection.rsrented.Fields.Refresh
myconnection.rsrented.Close
End Sub
