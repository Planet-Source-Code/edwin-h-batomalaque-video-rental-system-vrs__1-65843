VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} unreturnmovies 
   Bindings        =   "unreturn.dsx":0000
   Caption         =   "Unreturn Movies"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "List of Unreturn Movies"
         Alignment       =   2
      EndProperty
      ItemType3       =   3
   ...
   EndProperty
End
Attribute VB_Name = "unreturnmovies"
...
Me.Refresh
mdifrmmain.lblstatus.Caption = "List of Unreturn Movies"
...
myconnection.rsmovierental.Fields.Refresh
myconnection.rsmovierental.Close
End Sub
